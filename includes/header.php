<?php
$app = new App;
$app->session_starting();
define ("APPURL","http://localhost/Restaurant_system");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <a href="<?php echo APPURL; ?>/food/cart.php" class="nav-item nav-link"><i class="fa-sharp fa-solid fa-cart-shopping"></i>Cart</a>
         ...
         <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/bookings.php?id=<?php  $_SESSION['user_id']; ?>">Bookings</a></li>
                       <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/orders.php?id=<?php  $_SESSION['user_id']; ?>">Orders</a></li>
