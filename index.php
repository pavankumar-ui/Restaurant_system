...
<div class="container-xxl py-5 bg-dark hero-header mb-5">
 ...
 <a href="<?php echo APPURL; ?>/booking.php" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Book A Table</a>
                        ...
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="<?php echo APPURL; ?>/img/hero.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<?php 
//meal_id refers to breakfast lunch and dinner displayed on tabs//
...
$query = "SELECT * from  reviews order by r_id desc";
$app = new App;
...
<div id="tab-1" class="tab-pane fade show p-0 active">
    ...
    <img class="flex-shrink-0 img-fluid rounded" src="img/<?php echo $meal_1->image; ?>" alt="" style="width: 80px;">
          ...
          <?php  if(isset($_SESSION['user_id'])) {    ?>
                     <a type="button" href="<?php echo APPURL; ?>/food/add-cart.php?id=<?php echo  $meal_1->f_id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
          <?php }else{  ?>
          
    <a type="button"  class="btn btn-primary py-2 top-0 end-0 mt-2 me-2 view_error">view</a>
...
<?php  if(isset($_SESSION['user_id'])) {    ?>
    <a type="button" href="<?php echo APPURL; ?>/food/add-cart.php?id=<?php echo  $meal_2->f_id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
          <?php }else{  ?>
...
<?php   }     ?>
    ...
    <span class="text-primary">$<?php  echo $meal_3->price; ?></span>
        ...
        <small class="fst-italic"><?php  echo $meal_3->description; ?></small>
          ...
          <?php  if(isset($_SESSION['user_id'])) {    ?>
    <a type="button" href="<?php echo APPURL; ?>/food/add-cart.php?id=<?php echo  $meal_3->f_id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
          <?php }else{  ?>
    ...
    <input type="text" name="date_booking" class="form-control datetimepicker-input" id="datetime" placeholder="Date & Time" data-target="#date3" data-toggle="datetimepicker" />
                 ...
                 <textarea class="form-control" placeholder="Special Request" id="special_request" name="special_request" style="height: 100px"></textarea>
                    ...
                    <div class="col-12">
    <button class="btn btn-primary w-100 py-3 book_btn">Book Now
        </button>
                </div>
                </div>
            </form>
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonial-carousel">
                 ...
                 <?php foreach($reviews as $rw) { ?>
                    <div class="testimonial-item bg-tran sparent border rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                        <p><?php echo $rw->review; ?></p>
                        <div class="d-flex align-items-center">
                            
                            <div class="ps-3">
                                <h5 class="mb-1"><?php echo $rw->username; ?></h5>
